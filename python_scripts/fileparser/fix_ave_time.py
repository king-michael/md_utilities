...
def read_ave_time(fname,
                 dim=1,
                 dtype=float):
    # type: (str, int, type) -> (numpy.ndarray, numpy.ndarray)
    r"""
    ...
    # Warings
    if not constant:
        warnings.warn("Not a constant number of values per timestep")
    ...
    if dim == 1:
        ...
        warnings.warn("dim not tested yet")
